...
public class ParkingLot {
	...
	public ParkingLot(int capacity) {
		...
		if (capacity < 0) {
			...
			throw new IllegalArgumentException("Invalid capacity for parking lot");
	...
	public void park(Car c, int timestamp) {
		...
		if (attemptParking(c, timestamp)) {
			...
			System.out.println("Cannot park car, parking lot is at capacity");
		}
	...
	public Spot remove(int i) {
		...
		Spot carSpot = occupancy.remove(i);
		return carSpot;
